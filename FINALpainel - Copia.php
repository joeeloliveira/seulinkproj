...
<head>
    ...
    <style>
        ...
        @keyframes mudarCor {
            ...
            25% {
                color: rgb(0, 128, 0); /* Cor intermediária (Green) */
            }
            50% {
                color: rgb(34, 139, 34); /* Outra cor intermediária (ForestGreen) */
            }
            75% {
                color: rgb(0, 255, 0); /* Mais uma cor intermediária (Lime) */
            }
            100% {
                color: rgb(50, 205, 50); /* Cor final (LimeGreen) */
            }
        }
...
<body>
    <div class="container">
    <img src="seulinkLOGO1.png" alt="Seulink" width="350" height="350">
