...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" media="screen and (min-width: 1000px)" href="desktop2.css">
...
<body>
        ...
        <div id="showcase-container">
            <div class="feature">
                ...
                <form action="" method="post">
                    ...
                    <div class="select-styled"><img src="logooo1.png" style="margin-left: -3px;" alt="Imagem 0"></div>
                    <div class="select-options" name="escolha[]">
                        <ul>
                            <li data-value="amazon" value="amazon">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/amazon.png" alt="Imagem 1"> </li>
                            <li data-value="kabum" value="kabum">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/kabum.png" alt="Imagem 2"> </li>
                            <li data-value="magazine" value="magazine">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/magalu.png" alt="Imagem 3"> </li>
                            <li data-value="aliexpress" value="aliexpress">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/aliex.png" alt="Imagem 4"> </li>
                            <li data-value="banggood" value="banggood">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/bang.png" alt="Imagem 5"></li>
                            <li data-value="shein" value="shein">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/shien.png" alt="Imagem 6"></li>
                            <li data-value="mercado_livre" value="mercado_livre">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/ml.png" alt="Imagem 7"></li>
                            <li data-value="americanas" value="americanas">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/americanas.png" alt="Imagem 8"></li>
                            <li data-value="casas_bahia" value="casas_bahia">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/casas.jpg" alt="Imagem 9"></li>
                            <li data-value="submarino" value="submarino">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/sub.png" alt="Imagem 10"></li>
                            <li data-value="shoptime" value="shoptime">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/shop.png" alt="Imagem 10"></li>
                            <li data-value="extra" value="extra">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/extra.png" alt="Imagem 10"></li>
                            <li data-value="ponto_frio" value="ponto_frio">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/ponto.jpg" alt="Imagem 10"></li>
                            <li data-value="nagem" value="nagem">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/nagem.png" alt="Imagem 10"></li>
                            <li data-value="carrefour" value="carrefour">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/carrefour.png" alt="Imagem 10"></li>
                            <li data-value="havan" value="havan">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/havan.jpg" alt="Imagem 10"></li>
                            <li data-value="kalunga" value="kalunga">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/kalunga.png" alt="Imagem 10"></li>
                            <li data-value="dell" value="dell">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/dell.png" alt="Imagem 10"></li>
                            <li data-value="netshoes" value="netshoes">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/netshoes.png" alt="Imagem 10"></li>
                            <li data-value="nike" value="nike">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/nike.jpg" alt="Imagem 10"></li>
                            <li data-value="adidas" value="adidas">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/adidas.jpg" alt="Imagem 10"></li>
                            <li data-value="mizuno" value="mizuno">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/mizuno.jpg" alt="Imagem 10"></li>
                            <li data-value="lacoste" value="lacoste">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/lacoste.jpg" alt="Imagem 10"></li>
                            <li data-value="centauro" value="centauro">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/centauro.png" alt="Imagem 10"></li>
                            <li data-value="dafiti" value="dafiti">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/dafiti.png" alt="Imagem 10"></li>
                            <li data-value="renner" value="renner">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/renner.jpg" alt="Imagem 10"></li>
                            <li data-value="olx" value="olx">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/olx.png" alt="Imagem 10"></li>
                            <li data-value="elo7" value="elo7">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/elo7.png" alt="Imagem 10"></li>
                            <li data-value="mobly" value="mobly">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/mobly.png" alt="Imagem 10"></li>
                            <li data-value="madeira" value="madeira">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/madeira.png" alt="Imagem 10"></li>
                            <li data-value="pague_menos" value="pague_menos">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/paguemenos.png" alt="Imagem 10"></li>
                            <li data-value="droga_raia" value="droga_raia">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/drogasraia.png" alt="Imagem 10"></li>
                            <li data-value="drogasil" value="drogasil">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/drogasil.png" alt="Imagem 10"></li>
                            <li data-value="max_titanium" value="max_titanium">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/max.jpg" alt="Imagem 10"></li>
                            <li data-value="integral_medica" value="integral_medica">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/integral.png" alt="Imagem 10"></li>
                            <li data-value="new_nutrition" value="new_nutrition">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/nutrition.png" alt="Imagem 10"></li>
                            <li data-value="steam" value="steam">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/steam.png" alt="Imagem 10"></li>
                            <li data-value="microsoft" value="microsoft">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/xbox.png" alt="Imagem 10"></li>
                            <li data-value="playstation" value="playstation">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/sony.png" alt="Imagem 10"></li>
                            <li data-value="ubisoft" value="ubisoft">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/ubisoft.png" alt="Imagem 10"></li>
                            <li data-value="gog" value="gog">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/gog.png" alt="Imagem 10"></li>
                            <li data-value="battlenet" value="battlenet">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/battle.png" alt="Imagem 10"></li>
                            <li data-value="nuuvem" value="nuuvem">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/nuuvem.png" alt="Imagem 10"></li>
                            <li data-value="g2a" value="g2a">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/g2a.png" alt="Imagem 10"></li>
                            <li data-value="eneba" value="eneba">
                                <img style="width: 33px; height: 33px; margin-left: -3px;" src="icones/eneba.png" alt="Imagem 10"></li>
                        </ul>
                    </div>
                </div>


                <select name="escolha[]" style="font-size: 14.2px; background: #111313; color: white; border-radius: 5px; font-family: 'Lucida Console', Courier, monospace; height: 26px; width: 85%;">
                ...
                <h6><strong>Copie e cole</strong> o url abaixo ↴ </h6>
                    ...
                    <button type="button" class="botao-remover" onclick="removerCampo(this)"><h10>-</h10></button>
                    <br>
                </div>
            </div>
            <button type="button" style="width: 120px; height: 30px;" class="botao-adicionar" onclick="adicionarCampo()"><h11>+ adicionar</h11></button>
    ...
    function adicionarCampo() {
        if (contadorCampos < limiteCampos) {
            ...
            conteudoPersonalizado.innerHTML = '<img src="logooo1.png" style="margin-left: -3px;" alt="Imagem 0">';
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["gerar_link"])){
    ...
    for ($i = 0; $i < count($escolhas); $i++) {
        ...
        if (!$linkValidado) {
            return "Informe um link válido para " . $escolha . "<br>";
            continue;
        } elseif (strlen($linkValidado) <= 10 || strlen($linkValidado) > 1800) {
            return "Informe um link válido com mais de 10 caracteres e menos de 1800 caracteres para " . $escolha . "<br>";
            continue;
        }
        ...
        elseif ($escolha == "kabum") 
        {
            ...
            $preco = getStr($resp, 'h4 class="sc-5492faee-2 hAMMrD finalPrice">', '</h4');
            $preco_formatado = str_replace('h4 class="sc-5492faee-2 hAMMrD finalPrice">', '', $preco);
...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" media="screen and (min-width: 1000px)" href="desktop.css">
    <link rel="stylesheet" media="screen and (max-width: 800px)" href="mobile2.css">
    <title>Seulink.link</title>
</head>
...
<body>
    ...
    <div class="blue-line"></div>
    <h7>Copyright © 2023 <strong>seulink.link</strong> <p>- Todos os direitos reservados.</p></h7><br>
    <h8>Desenvolvido por <strong>Leoj</strong> <a href="https://github.com/joeeloliveira" target="_blank"><i class="fab fa-github"></i></a>.</h8>

    <div class="feature">
    <a href="https://seulink.link" target="_blank">
    <img src="seulinkis.png" alt="Seulink3">
    </a></a>
    <br>
    <img src="loading2.gif" alt="Seulink2">
    <img src="logozao.png" alt="Seulink4">
    <h12>✔️Seulink : </h12>
...
<div class="feature-right" id="feature-right">
<?php
if(isset($_POST["gerar_link"])) {
    $var1 = '<center><p><a href="';
    $var2 = '" target="_blank" style="color: #7F93DC; font-size: 15px; animation: mudarCor 5s infinite, mudarCorBorda 5s infinite; border: 2px dashed; border-radius: 10px; padding: 5px;"><strong> 💾 CLIQUE AQUI</strong>, SEU LINK FOI GERADO ↩</a></p></center>';
