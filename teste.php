...
<head>
    ...
    <style>
        ...
        #video-bg {
            object-fit: cover; /* Redimensiona o vídeo para cobrir todo o elemento pai */
            width: 100%;
            height: 100%;
        }
        ...
        h4 {
            text-align: left;
            color: rgb(50, 205, 50); /* Cor inicial (LimeGreen) */
            animation: mudarCor 5s linear infinite alternate;/* 5 segundos de duração */
            font-family: "Lucida Console", Courier, monospace; 
        }
        ...
        @keyframes mudarCor {
            ...
            45% {
                color: rgb(34, 139, 34); /* Verde */
            }
            50% {
                color: rgb(0, 128, 0); /* Verde escuro */
            }
            75% {
                color: rgb(0, 100, 0); /* Verde mais escuro */
            }
            100% {
                color: rgb(0, 128, 0); /* Volta para o verde */
            }
        }
        ...
        button {
            background: rgb(149, 202, 73); /* Cor de fundo em RGB */
            ...
            transition: background 0.8s; /* Transição mais suave */
        }

        button:hover {
            background: linear-gradient(to bottom, rgb(149, 202, 73), rgb(95, 154, 48)); /* Gradiente RGB ao passar o mouse */
        }
...
<body>
    <div class="video-background">
        <video autoplay muted loop id="video-bg">
            ...
            <!-- Adicione formatos de vídeo adicionais para compatibilidade com outros navegadores -->
        </video>
    </div>
    <div class="content">
        <div class="container">
        <img src="seulinki.png" alt="Seulink" width="270" height="220">
            <h4>Clique e escolha o website:</h4>
            <form action="" method="post">
                <div id="campos">
                    <div>
                        ...
                        <h6>Copie e cole o URL abaixo ↴</h6>
                ...
                <br><br>
                <input type="submit" style="width: 200px; height: 40px;" value="Enviar">
            </form>
        </div>
    </div>
    <!-- SCRIPT DAS TABELAS !-->
